...
/** @defgroup HT32F1xxxx_BOARD_Global_Variable HT32F1xxxx Board global variables
  ...
  */
  ...
  const u8 LED_GPIO_ID[LEDn] = {
    #if defined(LED1_GPIO_ID)
    LED1_GPIO_ID,
    #endif
    #if defined(LED2_GPIO_ID)
    LED2_GPIO_ID,
    #endif
    #if defined(LED3_GPIO_ID)
    LED3_GPIO_ID,
    #endif
    #if defined(LED4_GPIO_ID)
    LED4_GPIO_ID,
    #endif
  };

  const u16 LED_GPIO_PIN[LEDn] = {
    #if defined(LED1_GPIO_ID)
    LED1_GPIO_PIN,
    #endif
    #if defined(LED2_GPIO_ID)
  ...
  const AFIO_MODE_Enum LED_AFIO_MODE[LEDn] = {
    #if defined(LED1_GPIO_ID)
    LED1_AFIO_MODE,
    #endif
    #if defined(LED2_GPIO_ID)
